define({
  ...
  "projectSetting": {
    ...
    "selectLabel": "선택",
    "polygonLayerHelp": "<p>다음과 같은 조건의 폴리곤 레이어가 표시됩니다:<br/><ul><li>생성, 삭제, 업데이트라는 편집 기능이 있어야 하는 레이어</li><li>다음과 같은 이름과 데이터 유형이 사용된 2개의 필드가 있어야 하는 레이어:</li><ul><li>name(문자열 유형 필드)</li><li>globalid(GlobalID 유형 필드)</li></ul></ul><p/>",
    "outputParameterHelp": "<p>작업 URL의 결과 폴리곤 레이어가 표시됩니다.<p/>",
    "pointLayerHelp": "<p>다음과 같은 조건의 포인트 레이어가 표시됩니다: <br/><ul><li>생성, 삭제, 업데이트라는 편집 기능이 있어야 하는 레이어</li><li>다음과 같은 이름과 데이터 유형이 사용된 2개의 필드가 있어야 하는 레이어:</li><ul><li>inputtype(문자열 유형 필드)</li><li>projectid(GUID 유형 필드)</li></ul></ul><p/>"
  },
  "inputOutputTab": {
    "flag": "플래그",
    "barrier": "경계",
  ...
  "summaryTab": {
    ...
    "saveToLayerHelp": "<p>다음과 같은 조건의 레이어가 표시됩니다.<br/><ul><li>생성, 삭제, 업데이트라는 편집 기능이 있어야 하는 레이어</li><li>다음과 같은 이름과 데이터 유형이 사용된 2개의 필드가 있어야 하는 레이어:</li><ul><li>parametername(문자열 유형 필드)</li><li>projectid(Guid 유형 필드)</li></ul></ul><p/>",
