define({
  ...
  "projectSetting": {
    ...
    "pointLayerHelp": "<p>Punktlag med følgende vilkår vises: <br/><ul><li>Laget må ha redigeringsfunksjonene Opprett, Slett og Oppdater</li><li>Laget må ha to felt med eksakt navn og datatype:</li><ul><li>inputtype (strengfelt)</li><li>projectid (felttypen GUID)</li></ul></ul><p/>"
  },
  "inputOutputTab": {
    "flag": "Flagg",
    "barrier": "Hindring",
  ...
  "summaryTab": {
    ...
    "saveToLayerHelp": "<p>Layer med følgende vilkår blir vist:<br/><ul><li>Laget må ha redigeringsfunksjonene Opprett, Slett og Oppdater</li><li>Laget må ha to felt med eksakt navn og datatype:</li><ul><li>parameternavn (felt av typen streng)</li><li>prosjekt-ID (felt av typen GUID)</li></ul></ul><p/>",
