define({
  ...
  "projectSetting": {
    ...
    "selectLabel": "Vælg",
    "polygonLayerHelp": "<p>Polygonlag med følgende betingelser vil blive vist:<br/><ul><li>Laget skal have redigeringsfunktioner, nemlig Opret, Slet og Opdatér</li><li>Laget skal have to felter med præcist navn og datatyper:</li><ul><li>Name (Strengtypefelt)</li><li>GlobalID (GlobalID-typefelt)</li></ul></ul><p/>",
    "outputParameterHelp": "<p>Outputpolygonlag fra opgave-URL vil blive vist<p/>",
    "pointLayerHelp": "<p>Punktlag med følgende betingelser vil blive vist:<br/><ul><li>Laget skal have redigeringsfunktioner, nemlig Opret, Slet og Opdatér</li><li>Laget skal have to felter med præcist navn og datatyper:</li><ul><li>Inputtype (Strengtypefelt)</li><li>Projectid (GUID-typefelt)</li></ul></ul><p/>"
  },
  "inputOutputTab": {
    "flag": "Flag",
    "barrier": "Barriere",
