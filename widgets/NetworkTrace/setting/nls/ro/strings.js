define({
  ...
  "projectSetting": {
    ...
    "pointLayerHelp": "<p>Se vor afișa straturile tematice de tip punct cu următoarele condiții: <br/><ul><li>Stratul tematic trebuie să aibă capacități de editare, respectiv Creare, Ștergere și Actualizare</li><li>Stratul tematic trebuie să aibă 2 câmpuri cu numele și tipul de date exacte:</li><ul><li>inputtype (câmp tip șir)</li><li>projectid (câmp tip GUID)</li></ul></ul><p/>"
  },
  "inputOutputTab": {
    "flag": "Steag",
    "barrier": "Barieră",
  ...
  "summaryTab": {
    ...
    "saveToLayerHelp": "<p>Stratul cu condițiile următoare va fi afișat:<br/><ul><li>Stratul trebuie să aibă capacități de editare, și anume Creare, Ștergere și Actualizare</li><li>Stratul trebuie să aibă două câmpuri cu tipul exact de nume și date:</li><ul><li>parametername (câmp tip șir)</li><li>projectid (câmp tip GUID)</li></ul></ul><p/>",
