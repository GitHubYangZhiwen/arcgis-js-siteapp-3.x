define({
  ...
  "projectSetting": {
    ...
    "note": "Märkus: projekti seaded on valikulised, kui konfigureeritud kasutaja saab projekti salvestada veebikaardi soovitud kihtides koos võrgukatkestuse alaga ja sisendparameetritega. Kasutaja saab salvestada muid väljundparameetreid vahekaardil “Väljund”.",
    ...
    "selectLabel": "Vali",
    "polygonLayerHelp": "<p>Kuvatakse polügoonikiht (-kihid) järgmiste tingimustega.<br/><li>Kihil peavad olema muutmisfunktsioonid, nimelt „Loo“, „Kustuta“ ja „Värskenda“</li><li>Kihil peab olema 2 välja täpse nime- ja andmetüübiga:</li><ul><li>nimi (stringitüüpi väli)</li><li>globalid (GlobalID tüüpi väli)</li></ul><p/>",
    "outputParameterHelp": "<p>Näidatakse väljundpolügooni kihti (kihte) ülesande URL-ilt<p/>",
    "pointLayerHelp": "<p>Kuvatakse punktikiht (-kihid) järgmiste tingimustega.<br/><li>Kihil peavad olema muutmisfunktsioonid, nimelt „Loo“, „Kustuta“ ja „Värskenda“</li><li>Kihil peab olema 2 välja täpse nime- ja andmetüübiga:</li><ul><li>sisendi tüüp (stringitüüpi väli)</li><li>globalid (GUID-tüüpi väli)</li></ul><p/>"
  },
  "inputOutputTab": {
    "flag": "Lipp",
    "barrier": "Tõke",
