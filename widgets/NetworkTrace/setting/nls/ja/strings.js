define({
  ...
  "summaryTab": {
    ...
    "saveToLayerHelp": "<p>次の条件を満たすレイヤーが表示されます:<br/><ul><li>レイヤーは編集機能 (つまり、作成、削除、更新) を持つ必要があります</li><li>レイヤーは、次の名前およびデータ タイプの 2 つのフィールドを持つ必要があります:</li><ul><li>parametername (文字列タイプ フィールド)</li><li>projectid (文字列タイプ フィールド)</li></ul></ul><p/>",
