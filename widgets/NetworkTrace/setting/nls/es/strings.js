define({
  ...
  "projectSetting": {
    ...
    "pointLayerHelp": "<p>Se mostrarán las capas de puntos que reúnan las siguientes condiciones: <br/><ul><li>La capa debe presentar funciones de edición, concretamente Crear, Eliminar y Actualizar</li><li>La capa debe tener dos campos con el mismo nombre y tipo de datos:</li><ul><li>inputtype (campo de tipo cadena de caracteres)</li><li>projectid (campo de tipo GUID)</li></ul></ul><p/>"
  },
  "inputOutputTab": {
    "flag": "Marcador",
    "barrier": "Barrera",
