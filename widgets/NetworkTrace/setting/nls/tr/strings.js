define({
  ...
  "summaryTab": {
    ...
    "saveToLayerHelp": "<p>Aşağıdaki koşulları içeren katmanlar gösterilir:<br/><ul><li>Katmanın Oluştur, Sil ve Güncelle adlı düzenleme yetenekleri olmalıdır</li><li>Katmanda ad ve veri türüne sahip iki alan bulunmalıdır:</li><ul><li>parametername (Dizi türü alanı)</li><li>projectid (Guid türü alanı)</li></ul></ul><p/>",
