define({
  ...
  "summaryTab": {
    ...
    "saveToLayerHelp": "<p>Буде показано шар з наступними умовами: <br/><ul><li> Шар повинен мати можливості редагування, а саме «Створити», «Видалити» й «Оновити»</li><li> Шар повинен мати два поля з іменем та типом даних:</li><ul><li> parametername (поле рядкового типу)</li> <li>projectid (поле типу Guid)</li></ul></ul><p/>",
