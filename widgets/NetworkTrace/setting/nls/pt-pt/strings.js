define({
  ...
  "projectSetting": {
    ...
    "polygonLayerHelp": "<p>Serão apresentadas layers de polígonos nas seguintes condições:<br/><ul><li>A camada deve ter capacidades de edição, nomeadamente Criar, Eliminar e Atualizar</li><li>A layer deve ter 2 campos com o nome e tipo de dados exatos:</li><ul><li>nome (tipo de campo String)</li><li>globalid (tipo de campo GlobalID)</li></ul></ul><p/>",
    "outputParameterHelp": "<p>Será(ão) apresentada(s) a(s) camada(s) de polígonos de saída do URL da tarefa<p/>",
    "pointLayerHelp": "<p>Serão apresentadas layers de pontos com as seguintes condições: <br/><ul><li>A layer deve ter capacidades de edição, nomeadamente Criar, Eliminar e Atualizar</li><li>A layer deve ter 2 campos com o nome e tipo de dados exatos:</li><ul><li>inputtype (tipo de campo String)</li><li>projectid (tipo de campo GUID)</li></ul></ul><p/>"
  },
  "inputOutputTab": {
    "flag": "Bandeira",
    "barrier": "Barreira",
  ...
  "summaryTab": {
    ...
    "saveToLayerHelp": "<p>Será apresentada a camada com as seguintes condições:<br/><ul><li>A camada deve ter capacidades de edição, nomeadamente Criar, Eliminar e Atualizar </li><li>A camada deve ter dois campos com o nome e tipo de dados:</li><ul><li>parametername (tipo de campo de String)</li><li>projectid (tipo de campo de Guid)</li></ul></ul><p/>",
