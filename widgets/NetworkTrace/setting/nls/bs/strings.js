define({
  ...
  "projectSetting": {
    ...
    "pointLayerHelp": "<p>Točkasti slojevi sa sljedećim uvjetima biti će prikazani: <br/><ul><li>Sloj mora imati mogućnosti uređivanja <p>Točkasti slojevi sa sljedećim uvjetima biti će prikazani: <br/><ul><li>Sloj mora imati mogućnosti uređivanja i to ponajprije \"Stvori\", \"Izbriši\" i \"Ažuriraj\"</li><li>Sloj mora imati dva polja s točnim imenom i vrstama podataka:</li><ul><li>inputtype (Polje vrste niza)</li><li>projectid (Polje vrste GUID-a)</li></ul></ul><p/>"
  },
  "inputOutputTab": {
    "flag": "Zastava",
    "barrier": "Ograničenje",
