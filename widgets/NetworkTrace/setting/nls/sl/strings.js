define({
  ...
  "summaryTab": {
    ...
    "saveToLayerHelp": "<p>Prikazan bo sloj z naslednjimi pogoji:<br/><ul><li>sloj mora imeti zmožnosti Ustvari, Izbriši in Posodobi</li><li>sloj mora imeti dve polji z imenom in tipom podatkov:</li><ul><li>ime parametra (polj tipa niza)</li><li>ID projekta (tip polja Guid)</li></ul></ul><p/>",
