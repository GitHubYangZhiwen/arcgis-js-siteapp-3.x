define({
  ...
  "summaryTab": {
    ...
    "saveToLayerHelp": "<p>Es mostrarà la capa amb les condicions següents:<br/><ul><li>La capa ha de tenir funcions d'edició, com ara \"Crea\", \"Suprimeix\" i \"Actualitza\"</li><li>La capa ha de tenir dos camps amb el nom i el tipus de dades:</li><ul><li>parametername (camp de tipus cadena)</li><li>projectid (camp de tipus GUID)</li></ul></ul><p/>",
