define({
  "layersPage": {
    ...
    "promptOnSaveTip": "Visa en uppmaning om det finns ändringar som inte har sparats i det aktuella geoobjektet. Inte tillgänglig när flera geoobjekt kopieras, de sparas automatiskt",
  ...
  "intersectionPage": {
    ...
    "intersectionLayerHint": "Korsningsprioriteten fastställs i fallande ordning. Använd pilarna under Åtgärder för att ändra lagerordningen och korsningsprioriteten."
  },
  "presetAll": {
