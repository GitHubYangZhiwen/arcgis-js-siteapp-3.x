define({
  "layersPage": {
    ...
    "promptOnSaveTip": "Mostra una sol·licitud quan l'entitat actual té canvis que no s'han desat. No està disponible si es copien diverses entitats, que es desen automàticament.",
  ...
  "intersectionPage": {
    ...
    "intersectionLayerHint": "La prioritat d'intersecció es determina segons l'ordre descendent. Feu servir les fletxes que hi ha a sota de les accions per canviar l'ordre de les capes i la prioritat d'intersecció."
  },
  "presetAll": {
