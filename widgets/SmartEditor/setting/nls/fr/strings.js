define({
  "layersPage": {
    ...
    "promptOnSave": "Inviter à enregistrer les modifications non enregistrées lors de la fermeture du formulaire ou de l'accès au prochain enregistrement",
    "promptOnSaveTip": "Afficher une invite lorsque l'entité actuelle comporte des modifications non enregistrées. Non disponible lors de la copie de plusieurs entités, qui sont alors enregistrées automatiquement.",
    "promptOnDelete": "Demander confirmation lors de la suppression d'un enregistrement",
    ...
    "autoSaveEdits": "Enregistrer automatiquement la nouvelle entité",
    "enableAttributeUpdates": "Afficher le bouton de mise à jour Actions des attributs",
    ...
    "enableValuePickerHint": "Afficher une invite lorsque plusieurs valeurs sont disponibles pour un champ avec une action attributaire d'intersection",
    "expandRelatedTable": "Développer toutes les couches/tables associées lors du chargement",
    "expandMainTable": "Développer les couches parents lors du chargement",
    "layerSettingsTable": {
  ...
  "intersectionPage": {
    ...
    "intersectionLayerHint": "La priorité des intersections est déterminée en ordre décroissant. Utilisez les flèches sous Actions pour modifier l'ordre des couches et la priorité des intersections."
  },
  "presetAll": {
  ...
  "attributeActionsPage": {
    ...
    "alreadyAppliedActionLayerMsg": "Action ${action} appliquée à ce champ ) partir des paramètres de la couche",
