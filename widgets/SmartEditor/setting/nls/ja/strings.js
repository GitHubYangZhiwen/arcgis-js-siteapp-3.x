define({
  "layersPage": {
    ...
    "promptOnSaveTip": "保存されていない編集内容が現在のフィーチャにある場合、プロンプトを表示します。 複数のフィーチャのコピー時には使用できません。これらは自動で保存されます。",
  ...
  "intersectionPage": {
    ...
    "intersectionLayerHint": "交点の優先順位は、降順で決定されます。 [アクション] の下の矢印を選択して、レイヤーの順序および交点の優先順位を変更します。"
  },
  "presetAll": {
