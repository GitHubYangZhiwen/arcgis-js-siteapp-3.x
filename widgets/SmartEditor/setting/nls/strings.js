define({
  root: ({
    layersPage: {
      ...
      promptOnSaveTip: "Display a prompt when the current feature has unsaved edits. Not available when copying multiple features; these are saved automatically.",
      ...
      autoSaveEdits: "Save new feature automatically",
    ...
    intersectionPage: {
      ...
      intersectionLayerHint: "Intersection priority is determined in descending order. Use the arrows under Actions to change the layer order and intersection priority."
    },
    presetAll: {
