define({
  "layersPage": {
    ...
    "promptOnSaveTip": "Exibe um lembrete quando a feição atual tem edições não salvas. Não disponível ao copiar múltiplas feições; estas são salvas automaticamente.",
    ...
    "autoSaveEdits": "Salvar nova feição automaticamente",
  ...
  "intersectionPage": {
    ...
    "intersectionLayerHint": "A prioridade de intersecção é determinada em ordem decrescente. Utilize as setas em Ações para alterar a ordem da camada e a prioridade de intersecção."
  },
  "presetAll": {
