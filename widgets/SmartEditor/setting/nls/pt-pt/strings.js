define({
  "layersPage": {
    ...
    "promptOnSaveTip": "Exibir uma mensagem quando o elemento atual tiver edições não guardadas. Não disponível quando se copia vários elementos; estes são guardados automaticamente.",
    ...
    "autoSaveEdits": "Guardar novo elemento automaticamente",
  ...
  "intersectionPage": {
    ...
    "intersectionLayerHint": "A prioridade de intersecção é determinada por ordem descendente. Utilizar as setas de Ações para alterar a ordem das camadas e a prioridade de intersecção."
  },
  "presetAll": {
