define({
  "layersPage": {
    ...
    "promptOnSaveTip": "Отображать запрос, когда у текущего объекта есть несохраненные изменения. Недоступно при копировании нескольких объектов, они сохраняются автоматически.",
    ...
    "autoSaveEdits": "Сохранять новые объекты автоматически",
  ...
  "intersectionPage": {
    ...
    "intersectionLayerHint": "Приоритет пересечения определяется в убывающем порядке. Используйте стрелки под Действиями, чтобы изменить порядок слоев и приоритет пересечения."
  },
  "presetAll": {
